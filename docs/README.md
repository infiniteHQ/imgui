IMPORTANT : This repository is a fork of imgui ui system. This fork provides more behavior and adaptations for Vortex. Including CMake compilation.
Original Project : https://github.com/ocornut/imgui
